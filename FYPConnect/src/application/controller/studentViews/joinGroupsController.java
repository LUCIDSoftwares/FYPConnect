...
public class joinGroupsController {
	...
	public void initialize() {
		...
		// if the user is a leader, he will get requests from other people to join group
		// in this combo box
		// if the user is not a leader, he will get invitations to join group in this
		// combo box
		...
		// get all the groups where a user can be a member, and the user is already a
		// member of any group, do not show anything
	...
	public void acceptInvite() {
		...
		if (isLeader) {
			...
			if (selectedperson != null && !selectedperson.isEmpty()) {
				boolean isAccepted = dbHandler.acceptRequest(dbHandler.getGroupName(user.getUsername()),
						selectedperson); // Use the corrected method
